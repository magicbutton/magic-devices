...
func AddEndpoints(s *web.Service, jwtAuth func(http.Handler) http.Handler) {
	s.Route("/v1", func(r chi.Router) {
		r.Group(func(r chi.Router) {
			...
			r.Method(http.MethodPost, "/import/fullkpi", nethttp.NewHandler(ImportFullkpiPost()))
			r.Method(http.MethodPost, "/import/intune", nethttp.NewHandler(ImportIntunePost()))
			r.Method(http.MethodPost, "/import/tabelle", nethttp.NewHandler(ImportTabellePost()))
