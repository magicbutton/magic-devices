...
func ExtractDownloadExcelPost() usecase.Interactor {
	type Request struct {
	}
	u := usecase.NewInteractor(func(ctx context.Context, input Request, output *string) error {

		_, err := execution.ExecutePowerShell("john", "*", "magic-devices", "21-extract", "40-importintosql.ps1", "")
		if err != nil {
			return err
		}
